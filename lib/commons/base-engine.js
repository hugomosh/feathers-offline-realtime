...
export default class BaseEngine {
  constructor(service, options = {}) {
    ...
    this._listener = eventName => remoteRecord => this._mutateStore(eventName, remoteRecord, 0);
  ...
  _mutateStore(eventName, remoteRecord, source) {
    ...
    const idName = this._serviceId ? this._serviceId : this._useUuid ? 'uuid' : 'id' in remoteRecord ? 'id' : '_id';
